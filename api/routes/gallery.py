...
from api.models import GalleryImage, GalleryImageCreate, GalleryImageUpdate
...
async def create_gallery_image(
    ...
    try:
        ...
        if file and file.filename:
            # Vercel Serverless doesn't support persistent local file uploads
            raise HTTPException(
                status_code=400, 
                detail="File uploads are not supported in this serverless environment. Please use an image URL."
            )
